...
echo json_encode(array("title"=>_lang('Subscription removed!'),"text"=>_lang('You will no longer see this user\'s actions in <a href="'.site_url().buzz.'/">your notifications</a>!')));
}
} 
?>